(function (c, a) {
    ...
    d.multiAchieve = function (h) {
        ...
        p.find("p").find("span").text(q.selectIndex > 0 ? q.selectIndex : "");
    ...
    d.deletes = function (i) {
        ...
        if (f.options.multiSelect) {
            f.selectIndex -= 1;
            f.$selector.find("p").find("span").text(f.selectIndex > 0 ? f.selectIndex : "");
        ...
        if (g) {
            ...
            for (var j = 0; j < k.length; j++) {
                ...
                if (n.options.multiSelect) {
                    n.selectIndex = j + 1;
                    n.$selector.find("p").find("span").text(j + 1)
                }
            }
            n.values = [];
