...
public class R_order {
     ...
     * @mbg.generated Wed Jul 03 20:05:30 CST 2019
     */
    public R_order(Long oId, Integer uId, Integer roomId, Date oTime, Date arrDate, Date depDate, Integer quantity, Integer totalPrice, String gName, String gPhone, String oStatus) {
        this.oId = oId;
        this.uId = uId;
        this.roomId = roomId;
        this.oTime = oTime;
