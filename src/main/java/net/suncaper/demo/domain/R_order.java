...
public class R_order {
     ...
     * @mbg.generated Thu Jul 04 22:45:26 CST 2019
     */
    public R_order(Integer oId, Integer uId, Integer roomId, Date oTime, Date arrDate, Date depDate, Integer quantity, Integer totalPrice, String gName, String gPhone, String oStatus) {
        this.oId = oId;
        this.uId = uId;
        this.roomId = roomId;
        this.oTime = oTime;
    ...
    public R_order(Integer uId, Integer roomId, Date oTime, Date arrDate, Date depDate, Integer quantity, Integer totalPrice, String gName, String gPhone, String oStatus) {
        this.uId = uId;
        this.roomId = roomId;
        this.oTime = oTime;
        this.arrDate = arrDate;
